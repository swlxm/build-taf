...
public class MainPageAdv extends WebBasePage {
    ...
    @Getter
    @FindBy(how = How.XPATH, using = "//button[@aria-label='Open user account menu']")
    private static WebElement userProfileImg;

    public void clickSignIn() {
        clickElement(signInLnk);
        WebElement commitBtn = getElement(new LoginPageAdv().getSignInBtn());
        assertThat(commitBtn.isDisplayed()).isTrue();
    }

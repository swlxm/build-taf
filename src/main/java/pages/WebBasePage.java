...
//        WebDriverWait wait = new WebDriverWait(this.driver, Duration.ofSeconds((long)WaitDuration.IMPLICIT_HIGH.value()));
//        wait.until((input) -> {
...
//        int waitDuration = TimeUtils.parseTimeout(timeOutOfSeconds);
...
//        int count = TimeUtils.parseTimeout(timeOutOfSeconds);
...
//                }
//
//                Thread.sleep((long)WaitDuration.SLEEP.value());
//            } catch (InterruptedException var6) {
//                log.error("exception {}", var6.getMessage());
//            }
//
//            if (count-- == 0) {
//                log.error("{} is still exists in {} second(s)", element, TimeUtils.parseTimeout(timeOutOfSeconds));
//                break;
//            }
//        }
//
